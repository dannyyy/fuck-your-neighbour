...
export const T = {
  ...
  ruleErben: 'Erben (gleiche Karten am Schluss)',
  ruleErbenHint: 'Auflösung, wenn auf der letzten Karte die Spitzenkarten gleich sind.',
  erbenLower: 'Darunterliegende Karte',
  erbenLowerHint: 'Die nächsttiefere Karte erbt; bleibt alles gleich, gewinnt der dem Anspieler nächste Spieler.',
  erbenSplit: 'Beide machen den Stich',
  erbenSplitHint: 'Alle gleichauf liegenden Spieler erhalten den Stich.',
  erbenNone: 'Keiner macht den Stich',
  erbenNoneHint: 'Der Stich verfällt – niemand erhält ihn.',
  erbenSuit: 'Kartenfarbe entscheidet',
  erbenSuitHint: 'Rosen < Schilten < Eichel < Schellen.',
